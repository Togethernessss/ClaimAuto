...
// Hospital dashboard — shown after login for users with role = "Hospital".
// Uses the reusable WelcomeBanner component for consistency.
// Active Policies are fetched live from the backend on mount.
...
export default function HospitalDashboard() {
  ...
  return (
    <Container fluid>
      ...
      {/* ── Priority Action Bar (remittances) ───────────────────────────── */}
            ...
            <Card.Body>
              <div className="d-flex justify-content-between align-items-start">
                <div>
                  ...
                  <div className="fs-3 fw-bold text-muted">—</div>
                  <div className="small text-muted">
                    <i className="bi bi-clock me-1"></i> No pending claims
                  </div>
                </div>
            ...
            <Card.Body>
              <div className="d-flex justify-content-between align-items-start">
                <div>
                  ...
                  <div className="fs-3 fw-bold text-muted">—</div>
                  <div className="small text-muted">
                    <i className="bi bi-bank me-1"></i> No payments yet
                  </div>
                </div>
      ...
      {/* ── Middle row: Active Policies + Remittances + Recent Submissions ── */}
      <Row className="g-3 mb-4">

        {/* ── ACTIVE POLICIES CARD (LIVE DATA) ─────────────────────────────── */}
        <Col lg={4}>
                    ...
                    >
                      <div className="d-flex align-items-start gap-2">
                        <div
                          ...
                          style={{ width: 8, height: 8, backgroundColor: '#2e7d32', marginTop: 6 }}
                        ></div>
