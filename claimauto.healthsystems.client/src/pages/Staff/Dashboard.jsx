      ...
      <div className="px-4 pb-4">
        ...
        <Card className="border-0 shadow-sm mb-4 border-start border-danger border-4">
          <Card.Body className="d-flex align-items-center flex-wrap gap-3 py-3">
            <div className="rounded-circle bg-danger bg-opacity-10 text-danger d-flex align-items-center justify-content-center"
              ...
              <Card.Body>
                <div className="d-flex justify-content-between align-items-start">
                  <div>
                    ...
                    <div className="fs-3 fw-bold text-muted">—</div>
                    <div className="small text-muted"><i className="bi bi-check-circle me-1"></i> No tasks assigned</div>
                  </div>
              ...
              <Card.Body>
                <div className="d-flex justify-content-between align-items-start">
                  <div>
                    ...
                    <div className="fs-3 fw-bold text-muted">—</div>
                    <div className="small text-muted"><i className="bi bi-shield me-1"></i> No open cases</div>
                  </div>
        ...
        <div className="d-flex align-items-center mb-3">
          ...
          <Badge bg="success" pill className="text-uppercase" style={{ fontSize: 10 }}>● Live</Badge>
        </div>
        ...
        <Row className="g-3 mb-4">
            ...
            <Card className="border-0 shadow-sm h-100">
              <Card.Header className="bg-white border-0 py-3">
                <h6 className="mb-0 fw-semibold">
                  <i className="bi bi-file-earmark-text text-primary me-2"></i>Claims Awaiting Review
                </h6>
              ...
              <Card.Body>
                <div className="text-center py-5">
                  ...
                  <div className="small text-muted mt-1">High-priority claims will appear here first.</div>
                </div>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col lg={5}>
            <Card className="border-0 shadow-sm h-100">
              <Card.Header className="bg-white border-0 py-3">
                <h6 className="mb-0 fw-semibold">
                  <i className="bi bi-list-check text-success me-2"></i>My Tasks
                </h6>
              ...
              <Card.Body>
                <div className="text-center py-5">
                  ...
                  <div className="small text-muted mt-1">Tasks assigned to you will appear here.</div>
                </div>
              </Card.Body>
            </Card>
          </Col>
