...
{
    [TestFixture]// NUnit test class for ClaimsController
    public class ClaimsControllerTests
    {
        ...
        [SetUp]// Runs before each test to set up the test environment
        public void SetUp()
        {
        ...
        {
            // ── ARRANGE -> Set up the mock repository to return a fake claim when called with ID 1
            ...
            // ── ASSERT-> Verify that the result is a 200 OK with the expected claim data
